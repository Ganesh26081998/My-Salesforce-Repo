...
formatDate(dateStr) {
    ...
    // Fires when lightning-record-edit-form loads the record — captures pre-populated values
    ...
    syncEditFormValues() {
        // Read current DOM values — lightning-record-edit-form pre-populates from the record,
